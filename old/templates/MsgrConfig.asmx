<MsgrConfig>
	<Simple>
		...
		<MinFlashPlayer BuildNumber='60' MajorVersion='7' MinorVersion='0' />
		<Relay>
			<Enabled>0</Enabled>
		</Relay>
		<TrustedDomains>
	...
	<LocalizedConfig Market='en-US'>
		...
		<MSNSearch>
			...
			<SearchKidsURL
			>https://www.google.com/search?q=$QUERY$&amp;source=hp&amp;safe=active</SearchKidsURL>
		...
		<RL>
			<ViewProfileURL>
				http://g.msn.com/5meen_us/106?%1&amp;Plcid=%2!hs!&amp;%3&amp;Country=%4!hs!&amp;BrandID=%5&amp;passport=%6
			</ViewProfileURL>
		</RL>
		<TermsOfUse>
